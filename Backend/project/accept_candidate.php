...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        // Call the stored procedure to accept the application
        $stmt = $conn->prepare("CALL AccettaCandidatura(:p_email_candidato, :p_nome_progetto, :p_nome_profilo, :p_email_corrente)");
